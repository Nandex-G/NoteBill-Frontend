  ...
  return (
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-[#2a2e5c] to-[#3e497a] p-1 rounded-3xl shadow-2xl w-fit">
        <div className="bg-[#1f2333] text-white rounded-2xl px-6 py-8 sm:p-10 flex flex-col justify-center items-center relative w-full sm:w-[350px] md:w-[400px]">
            <span className="text-white/90 text-xl md:text-3xl font-bold mb-6 border-b border-[#4a516d] pb-3 w-full text-center">ورود</span>
            ...
            <form className="w-full flex flex-col gap-5 mb-6" onSubmit={handleSubmit}>
                ...
                <input className="bg-[#2a2f45] border border-[#3e4462] text-white placeholder:text-white/60 rounded-xl p-3 text-center text-base outline-none focus:ring-2 focus:ring-purple-400 transition" onChange={changeValue} value={form.password} type="password" name="password" required placeholder="رمز عبور" />
            ...
            <div className="text-sm text-white/70">حساب ندارید؟{" "}<Link to="/register" className="text-purple-300 hover:text-purple-200 underline transition">یکی بسازید</Link> </div>
